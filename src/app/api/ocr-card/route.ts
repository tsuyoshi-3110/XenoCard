...
const SYSTEM_PROMPT = [
  ...
  '"name", "company", "department", "title", "qualifications", "phone", "email", "website", "address".',
  "Rules:",
  ...
  "- title: 役職 = organizational position ONLY (e.g. 代表取締役, 部長, 課長, 主任, 店長). Empty if none.",
  "- qualifications: 資格・免許・称号 = licenses and certifications ONLY (e.g. 一級建築士, 二級建築施工管理技士, 宅地建物取引士, 一級塗装技能士, ファイナンシャルプランナー). Join multiple with 、",
  "- IMPORTANT: Never put qualifications into title, and never put 役職 into qualifications. 代表取締役 is a title; 一級建築士 is a qualification.",
